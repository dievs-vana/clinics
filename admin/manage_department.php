...
{
$id=$_GET['del'];
$sql = "delete from departmenttbl  WHERE id=:id";
...
<head>
	...
	<title>SVCC |Admin Manage Department groups   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Manage Departments Groups</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Listed Departments Groups</div>
