...
<?php include('includes/header.php');?>
    ...
    <div class="container">
        ...
        <h1 class="mt-4 mb-3">Search for<small>Department</small></h1>

        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="index.php">Home</a>
            </li>
            <li class="breadcrumb-item active">Search for Department</li>
        </ol>
...
<div><select name="Department" class="form-control" required>
...
$sql = "SELECT * from patienttbl where (status=:status and Department=:Department) ||  (Address=:location)";
$query = $dbh -> prepare($sql);
